...
using GazaHealthCenter.Objects.Mapping;

namespace GazaHealthCenter;
...
public static class TestingContext
{
    ...
    {
        IConfiguration config = new ConfigurationBuilder().AddJsonFile($"configuration.testing.json").AddEnvironmentVariables("GazaHealthCenter__Testing__").Build();
