...
public class ModuleModel
{
    ...
    public ModuleModel(String model, String controller, String? area)
    {
        ...
        Type modelType = assembly.GetType($"GazaHealthCenter.Objects.{model}") ?? typeof(AModel);
        Type viewType = assembly.GetType($"GazaHealthCenter.Objects.{model}View") ?? typeof(AView<>);
        BindingFlags declaredOnly = BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly;

        ControllerNamespace = $"GazaHealthCenter.Controllers.{area}".Trim('.');
        ...
        {
            Type type = assembly.GetType($"GazaHealthCenter.Objects.{model}{view}View") ?? viewType;
