...
namespace GazaHealthCenter.Web.Templates;
...
public class Module : GennyModule
{
    ...
    public override void Run()
    {
        ...
        {
            { $"../GazaHealthCenter.Services/{shortPath}{Model}Service.cs", Scaffold("Services/Service") },
            { $"../GazaHealthCenter.Validators/{shortPath}{Model}Validator.cs", Scaffold("Validators/Validator") },
            { $"../GazaHealthCenter.Controllers/{shortPath}{Controller}.cs", Scaffold("Controllers/Controller") },
            { $"../../test/GazaHealthCenter.Tests/Integration/Controllers/{shortPath}{Controller}Tests.cs", Scaffold("Tests/ControllerTests") },

            { $"../GazaHealthCenter.Web/Views/{path}/Index.cshtml", Scaffold("Web/Index") },
            { $"../GazaHealthCenter.Web/Views/{path}/Create.cshtml", Scaffold("Web/Create") },
            { $"../GazaHealthCenter.Web/Views/{path}/Details.cshtml", Scaffold("Web/Details") },
            { $"../GazaHealthCenter.Web/Views/{path}/Edit.cshtml", Scaffold("Web/Edit") },
            { $"../GazaHealthCenter.Web/Views/{path}/Delete.cshtml", Scaffold("Web/Delete") }
        };

        foreach (String view in model.ViewProperties.Keys.Where(key => key.Length == 0 || model.Views[key] != model.Views[""]))
            results[$"../GazaHealthCenter.Web/Resources/Views/{path}/{Model}{view}View.json"] = Scaffold($"Resources/{view}View");

        foreach (Type type in model.EnumTypes)
            results[$"../GazaHealthCenter.Web/Resources/Enums/{path}/{type.Name}.json"] = Scaffold("Resources/Enum", Enum.GetNames(type));

        if (!File.Exists($"../GazaHealthCenter.Objects/Models/{path}/{Model}.cs") ||
            !File.Exists($"../GazaHealthCenter.Objects/Views/{path}/{Model}View.cs"))
            results = new Dictionary<String, GennyScaffoldingResult>
            {
                { $"../GazaHealthCenter.Objects/Models/{path}/{Model}.cs", Scaffold("Objects/Model") },
                { $"../GazaHealthCenter.Objects/Views/{path}/{Model}View.cs", Scaffold("Objects/View") }
            };
    ...
    private void AddArea()
    {
        ...
        Logger.Write("../GazaHealthCenter.Controllers/Area.cs - ");

        String content = File.ReadAllText("../GazaHealthCenter.Controllers/Area.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../GazaHealthCenter.Controllers/Area.cs", content);
    ...
    {
        Logger.Write("../GazaHealthCenter.Web/mvc.sitemap - ");
    ...
    {
        Logger.Write("../GazaHealthCenter.Data/Migrations/Configuration.cs - ");

        String content = File.ReadAllText("../GazaHealthCenter.Data/Migrations/Configuration.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../GazaHealthCenter.Data/Migrations/Configuration.cs", content);
    ...
    {
        Logger.Write("../GazaHealthCenter.Web/Views/_ViewImports.cshtml - ");

        String content = File.ReadAllText("../GazaHealthCenter.Web/Views/_ViewImports.cshtml");
        String[] imports = Regex.Matches(content, "@using (.+);").Select(match => match.Value).ToArray();
        String[] newImports = imports
            .Append(Area == null ? "@using GazaHealthCenter.Controllers;" : $"@using GazaHealthCenter.Controllers.{Area};")
            .Distinct()
        ...
        else
        {
            ...
            File.WriteAllText("../GazaHealthCenter.Web/Views/_ViewImports.cshtml", content);
    ...
    {
        Logger.Write("../../test/GazaHealthCenter.Tests/Helpers/ObjectsFactory.cs - ");

        String content = File.ReadAllText("../../test/GazaHealthCenter.Tests/Helpers/ObjectsFactory.cs");
        ModuleModel model = new(Model!, Controller!, Area);
        ...
        else
        {
            ...
            File.WriteAllText("../../test/GazaHealthCenter.Tests/Helpers/ObjectsFactory.cs", newContent);
    ...
    {
        Logger.Write("../../test/GazaHealthCenter.Tests/Unit/Data/Migrations/ConfigurationTests.cs - ");

        String content = File.ReadAllText("../../test/GazaHealthCenter.Tests/Unit/Data/Migrations/ConfigurationTests.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../../test/GazaHealthCenter.Tests/Unit/Data/Migrations/ConfigurationTests.cs", content);
    ...
    {
        Logger.Write("../../test/GazaHealthCenter.Tests/Helpers/TestingContext.cs - ");

        String content = File.ReadAllText("../../test/GazaHealthCenter.Tests/Helpers/TestingContext.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../../test/GazaHealthCenter.Tests/Helpers/TestingContext.cs", content);
    ...
    {
        Logger.Write($"../GazaHealthCenter.Web/Resources/Shared/{resource}.json - ");
