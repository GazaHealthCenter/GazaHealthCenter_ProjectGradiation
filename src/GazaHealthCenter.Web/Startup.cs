...
namespace GazaHealthCenter.Web;
...
public class Startup
{
    ...
    public Startup(IHostEnvironment host)
    {
        ...
        Config = new ConfigurationBuilder()
            ...
            .AddEnvironmentVariables($"GazaHealthCenter__{host.EnvironmentName}__")
            .Build();
    }
